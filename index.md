# MyIG Home Page - Food Allergies FHIR Implementation Guide v0.1.0-test
...
| | |
| :--- | :--- |
| *Official URL*:http://xxsomewhere.org/fhir/food-Allergy/ImplementationGuide/food-Allergy | *Version*:0.1.0-test |
| Draft as of 2026-04-20 | *Computable Name*:FoodAllergyIG |
...
```json
{
  ...
  "id" : "food-Allergy",
  "url" : "http://xxsomewhere.org/fhir/food-Allergy/ImplementationGuide/food-Allergy",
  "version" : "0.1.0-test",
  "name" : "FoodAllergyIG",
  "title" : "Food Allergies FHIR Implementation Guide",
  "status" : "draft",
  "experimental" : false,
  ...
  "description" : "Test IG about food allergies",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "xxexample.fhir.food-Allergy",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://xxsomewhere.org/fhir/food-Allergy/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "AllergyIntolerance/MyPeanutAllergy"
      }
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/FoodAllergy"
      },
      "name" : "Food Allergy",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/FoodAllergyModel"
      },
      "name" : "Food Allergy Logical Model",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/FoodAllergyVS"
      },
      "name" : "Food Allergies",
    ...
    "page" : {
      ...
      },
      {
        ...
        "nameUrl" : "intro.html",
        "title" : "Food allergy - Introduction",
        "generation" : "markdown"
      },
      {
        "extension" : [{
